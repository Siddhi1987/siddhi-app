// pages/signup.jsx — email/password signup + "Continue with Google".
// The identity trigger (handle_new_user) auto-creates the public.users row on signup,
// so both paths link correctly to auth.uid().
//
...
export default function Signup() {
  ...
  const signUpWithEmail = async (e) => {
    ...
    // If email confirmation is OFF in Supabase, a session exists now -> go to dashboard.
    // If it's ON, no session yet -> tell them to confirm via email.
    if (data.session) {
