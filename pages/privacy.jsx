    ...
    <div className="min-h-screen bg-siddhi-ivory text-siddhi-black px-6 py-16 max-w-3xl mx-auto">
      ...
      <div className="prose prose-lg space-y-6">
        ...
        <section>
          ...
          <p>You may request access, correction, or deletion of your data at any time by emailing <strong>support@siddhiai.in</strong>.</p>
        </section>

        <section>
          <h2 className="font-display text-2xl font-semibold mb-2">5. Contact</h2>
          <p>For privacy questions: <strong>support@siddhiai.in</strong></p>
        </section>
      </div>
    </div>
  );
